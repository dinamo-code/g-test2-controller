        ...
        <tbody class="maincardcontainer">
            ...
            while($data = mysqli_fetch_array($result)){
             ...
             <tr class="cardcontainer" id="cardcontainer">
                    ...
                    <td class="cardemail"><span>Useremail </span><div id="Useremail"><?php echo $data ['Useremail'];?></div></td><!--name-->
                    <td class="cardloctionlink"><span>Userlocation </span><div id="Userlocation"><a href="<?php echo $data ['Userlocation'];?>" target="blank"><img src="imgs/maps-and-flags.png" alt="" style="width: 18px; height:18px;"></a></div></td><!--name-->
                    <td class="cardPaymethod"><span>Paymethod </span><div id="Paymethod"><?php echo $data ['Paymethod'];?></div></td><!--name-->
                    <td class="cardimg"><img src="<?php echo $data ['Product_image'];?>" id="Product_image"></td><!--image-->
                    <td class="cardpname"><span>Product name </span><div id="Product_name"><?php echo $data ['Product_name'];?></div></td><!--name-->
                    <td class="cardpprice"><span>Product price </span><div id="Product_pricer"><?php echo $data ['Product_price'];?><span class="dolarsign"> $</span></div></td><!--price-->
                    <td class="cardpcount"><span>Product count </span><div id="Product_count"><?php echo $data ['Product_count'];?></div></td><!--name-->
                    <td class="carddate"><span>Ordered at </span><div id="ordered_at"><?php echo $data ['ordered_at'];?></div></td><!--name-->
