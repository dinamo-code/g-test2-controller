...
<section>
    <div class="createmaincontainer">
        ...
        <form action="process.php" method="post" enctype="multipart/form-data"><!-- just image , name , description , price-->
            <div class="imgpricename">
            <div >
                <label for="Image">Image : </label>
                <input type="file" id="Image" name="my_image" required placeholder=" Put an image" class="imgfield">
            </div>
            ...
            <div class="descriptionfield">
                <label for="Description" class="descriptionfieldlabel"> Description : </label><!-- description-->
                <input type="text" id="Description" name="Description" required placeholder=" Write A Description" >
            </div>
            <div class="addbutton"><!-- add  product -->
